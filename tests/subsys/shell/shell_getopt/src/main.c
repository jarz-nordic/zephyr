...
static void test_getopt_long(void)
{
	...
	argv = (char **)argv1;
	z_shell_getopt_init(&shell->ctx->getopt_state);
	c = shell_getopt_long(shell, argc1, argv, accepted_opt,
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long(shell, argc2, argv, accepted_opt,
			      long_options, &option_index);
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long(shell, argc3, argv, accepted_opt,
			      long_options, &option_index);
	zassert_equal(verbose_flag, 0, "verbose flag expected");
	c = shell_getopt_long(shell, argc3, argv, accepted_opt,
			      long_options, &option_index);
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long(shell, argc4, argv, accepted_opt,
			      long_options, &option_index);
	zassert_equal(verbose_flag, 0, "verbose flag expected");
	c = shell_getopt_long(shell, argc4, argv, accepted_opt,
			      long_options, &option_index);
...
static void test_getopt_long_only(void)
{
	...
	argv = (char **)argv1;
	z_shell_getopt_init(&shell->ctx->getopt_state);
	c = shell_getopt_long_only(shell, argc1, argv, accepted_opt,
				   long_options, &option_index);
	zassert_equal(verbose_flag, 1, "verbose flag expected");
	c = shell_getopt_long_only(shell, argc1, argv, accepted_opt,
				   long_options, &option_index);
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long_only(shell, argc2, argv, accepted_opt,
				   long_options, &option_index);
	zassert_equal(verbose_flag, 0, "verbose flag expected");
	c = shell_getopt_long_only(shell, argc2, argv, accepted_opt,
				   long_options, &option_index);
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long_only(shell, argc3, argv, accepted_opt,
				   long_options, &option_index);
	zassert_equal(verbose_flag, 0, "verbose flag expected");
	c = shell_getopt_long_only(shell, argc3, argv, accepted_opt,
				   long_options, &option_index);
	...
	z_shell_getopt_init(&shell->ctx->getopt_state);
	state = shell_getopt_state_get(shell);
	c = shell_getopt_long_only(shell, argc4, argv, accepted_opt,
				   long_options, &option_index);
	zassert_equal(verbose_flag, 0, "verbose flag expected");
	c = shell_getopt_long_only(shell, argc4, argv, accepted_opt,
				   long_options, &option_index);
